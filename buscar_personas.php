...
<?php include_once './vistas/navbar.php' ?>
      <section class="container mt-4 pt-4 buscador-personas">
        <h1 class="h1-encabezado pt-4 mb-4 pb-4">Buscador de personas</h1>
      </section> 
      <section class="container"> 
        <form class="form-card">
          <fieldset class="p-4 border">
            <legend class="w-auto">Completar uno o más valores para realizar la búsqueda</legend>
            <div class="row">
      ...
      function buscarDatos (valor1, valor2, valor3) {
        ...
        $.ajax({
          ...
          type: 'post',
          beforeSend: function() {
            $("#resultado-personas").html("<div class='alert alert-info' role='alert'>Realizando búsqueda...</div>");
          },
